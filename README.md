...
<FrameLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <com.budiyev.android.codescanner.CodeScannerView android:id="@+id/scanner_view"
        ...
        app:autoFocusButtonColor="@android:color/white" app:autoFocusButtonVisible="true"
        app:flashButtonColor="@android:color/white" app:flashButtonVisible="true"
        app:frameColor="@android:color/white" app:frameCornersSize="50dp"
        app:frameCornersRadius="0dp" app:frameAspectRatioWidth="1" app:frameAspectRatioHeight="1"
        app:frameSize="0.75" app:frameThickness="2dp" app:frameVerticalBias="0.5"
